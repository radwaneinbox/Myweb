...
const testimonials = [
  {
    ...
    quote: 'This portfolio builder helped me showcase my work professionally. The customization options are amazing!'
  },
  {
    name: 'Michael Chen',
    role: 'Web Developer',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
    quote: 'I created my portfolio in under an hour. The templates are modern and the interface is intuitive.'
  },
  {
    name: 'Emily Davis',
    role: 'Graphic Designer',
    image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=crop&w=128&q=80',
    quote: 'The best portfolio builder I\'ve used. It perfectly highlights my creative work.'
  }
];
